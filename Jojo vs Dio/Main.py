...
pygame.display.set_caption("DIODA")
#colors
c1 = (255, 255, 255)
c2 = (160, 32, 240)
c3 = (255, 0, 0)
...
Blubullet = []
Redbullet = []
sound1 = pygame.mixer.Sound('ora.mp3')
sound2 = pygame.mixer.Sound('muda.mp3')
sound3 = pygame.mixer.Sound('zawardo.mp3')
sound4 = pygame.mixer.Sound('music.mp3')
#images
plr1 = pygame.image.load("Player1.webp")
plr2 = pygame.image.load("Player2.webp")
...
Player1 = Player(plr1, 10, 40, 300)
Player2 = Player(plr2, 10, 600, 300)
